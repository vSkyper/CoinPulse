...
export default function Tooltips() {
  return (
    ...
    >
      ...
      <GitHubIcon className='text-[0.9rem]! sm:text-[1.1rem]! transition-all duration-300 group-hover:-rotate-[5deg] group-hover:scale-110 group-hover:text-brand-violet' />
    </a>
  );
}
