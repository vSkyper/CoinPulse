  ...
  return (
    <div className='flex items-center justify-center gap-2 sm:gap-2'>
      ...
      <Link
        ...
        className='hidden sm:flex items-center justify-center rounded-lg sm:rounded-lg transition-all duration-300 ease-out relative overflow-hidden group bg-linear-to-br from-brand-violet to-brand-violet-light border border-white/10 hover:-translate-y-0.5 hover:scale-105 active:-translate-y-px active:scale-[1.02] p-1.5 sm:p-1.5 text-white shadow-glow-primary'
      >
        ...
        <TrendingUpIcon className='text-[1.1rem]! sm:text-[1rem]! drop-shadow-text' />
      </Link>
