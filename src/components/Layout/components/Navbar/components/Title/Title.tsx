  ...
  return (
    <div className='flex items-center justify-center gap-2 sm:gap-3'>
      ...
      <Link
        ...
        className='flex items-center justify-center rounded-lg sm:rounded-xl transition-all duration-300 ease-out relative overflow-hidden group bg-linear-to-br from-(--brand-blue) to-(--brand-blue-light) border border-white/10 hover:-translate-y-0.5 hover:scale-105 hover:shadow-[0_0_20px_rgba(139,92,246,0.4)] active:-translate-y-px active:scale-[1.02] p-1 sm:p-2 text-white shadow-[0_0_15px_rgba(139,92,246,0.2)]'
      >
      ...
      <h1 className='hidden sm:block'>
        ...
        >
          ...
          <span className='text-(--brand-blue)'>CURRENCY</span>
        </Link>
      </h1>
