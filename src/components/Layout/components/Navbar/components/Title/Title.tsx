  ...
  return (
    <div className='flex items-center justify-center gap-2 sm:gap-3'>
      ...
      >
        ...
        <TrendingUpIcon className='text-[1rem]! sm:text-[1.4rem]! drop-shadow-sm' />
      </Link>
