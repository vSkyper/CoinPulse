      ...
      >
        <div className='pointer-events-auto'>
          <AnimatePresence>
            {!isHeaderVisible && (
              <motion.div
                ...
                className='mx-auto w-full bg-white/2 backdrop-blur-xl backdrop-saturate-150 border border-white/5 shadow-dropdown rounded-xl sm:rounded-2xl z-10 relative'
              >
          ...
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className={`mx-auto w-full bg-white/2 backdrop-blur-xl backdrop-saturate-150 border border-white/5 shadow-dropdown rounded-xl sm:rounded-2xl ${
