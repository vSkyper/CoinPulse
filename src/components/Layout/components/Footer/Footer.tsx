      ...
      <div className='px-4 py-4 sm:py-6 flex items-center justify-center'>
        <div className='flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 w-full max-w-7xl mx-auto'>
          ...
          <div className='flex flex-col items-center sm:items-start gap-1'>
            <h3 className='text-sm sm:text-base font-black tracking-tighter text-white flex items-center gap-2'>
            ...
            <p className='text-[0.6rem] sm:text-[0.65rem] text-white/30 font-medium uppercase tracking-wider'>
