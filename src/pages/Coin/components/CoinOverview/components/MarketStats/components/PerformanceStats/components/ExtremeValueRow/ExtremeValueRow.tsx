      ...
      <div className="flex flex-row items-center gap-2 mb-2 sm:mb-4">
        <div className="font-bold text-base sm:text-xl text-white tracking-tight min-w-0 overflow-hidden">
          <Tooltip
            ...
            content={
              fullValue !== undefined ? fullValue : formatCurrency(price)
            }
          />
        </div>
        <div
          className={`text-[10px] sm:text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded sm:rounded-md flex items-center gap-0.5 shrink-0 ${
            percentage >= 0
