...
export default function ExtremeValueRow({
  ...
  return (
    <>
      <div className='flex flex-col justify-between min-h-20 sm:min-h-[120px] p-4 sm:p-5 rounded-2xl bg-[#0a0a0f]/60 backdrop-blur-xl backdrop-saturate-150 border border-white/10 shadow-dropdown transition-all duration-300'>
