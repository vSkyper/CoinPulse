...
export default function PriceChange({ marketData, days }: PriceChangeProps) {
  ...
  return (
    <div className='col-span-1'>
      <div
        className={`flex flex-col items-center justify-center relative overflow-hidden bg-white/2 rounded-xl p-4 sm:p-3 border border-white/5 shadow-dropdown transition-all duration-300 ${colorClass}`}
      >
        <div
