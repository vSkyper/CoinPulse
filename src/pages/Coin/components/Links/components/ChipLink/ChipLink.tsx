...
export default function ChipLink({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-[0.65rem] sm:text-xs font-bold transition-all duration-300 ease-out relative overflow-hidden backdrop-blur-xl backdrop-saturate-150 group border border-white/10 bg-bg-glass/60 shadow-dropdown hover:bg-white/10 hover:border-white/20 hover:-translate-y-0.5 ${className}`}
    >
