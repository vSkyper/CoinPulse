...
export default function ChipLink({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-1 sm:py-1 rounded-lg text-[10px] sm:text-[11px] font-bold transition-all duration-300 ease-out relative overflow-hidden backdrop-blur-xl backdrop-saturate-150 group border border-white/5 bg-white/2 hover:bg-white/5 hover:border-white/10 ${className}`}
    >
