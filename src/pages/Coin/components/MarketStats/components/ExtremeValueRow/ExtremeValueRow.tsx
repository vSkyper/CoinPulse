...
export default function ExtremeValueRow({
  ...
  return (
    <>
      <div className='relative overflow-hidden flex flex-col justify-between min-h-20 sm:min-h-[96px] p-4 sm:p-3 rounded-2xl bg-glass/60 backdrop-blur-xl backdrop-saturate-150 border border-white/10 shadow-dropdown transition-all duration-300'>
