      ...
      {({ open }) => (
        <>
          ...
          <MenuItems
            ...
            className='w-36 sm:w-36 origin-top-right divide-y divide-white/5 rounded-xl bg-glass/80 backdrop-blur-xl shadow-popover ring-1 ring-white/5 focus:outline-none border border-white/10 z-50 transition duration-100 ease-out data-closed:scale-95 data-closed:opacity-0'
          >
