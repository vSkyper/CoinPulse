      ...
      <div className='flex items-center gap-2 sm:gap-2 w-full sm:w-auto'>
        <div className='relative group flex-1 sm:flex-none'>
          ...
          <input
            ...
            className='bg-white/5 border border-white/10 rounded-xl sm:rounded-xl py-2 sm:py-1.5 pl-9 sm:pl-9 pr-3 sm:pr-3 text-xs sm:text-xs text-white/90 placeholder-white/40 focus:outline-none focus:border-white/20 focus:bg-white/10 focus:shadow-glow-white-sm transition-all duration-300 w-full sm:w-56'
          />
        </div>
        <button
          ref={filterButtonRef}
